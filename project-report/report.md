...
+@fig:svmModel2Summary shows the summary after applying the svm model to the training dataset.

![SVM Model2 Summary [@image-svm-model2-summary]](images/svmModel2_summary.png){#fig:svmModel2Summary}


+@fig:svmModel2ConfMat is the confusion matrix generated by the code for the svm model.
